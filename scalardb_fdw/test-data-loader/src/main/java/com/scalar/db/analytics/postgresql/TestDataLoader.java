...
public class TestDataLoader {
    ...
    private static void createCassandraTestTable(DistributedTransactionAdmin admin) throws ExecutionException {
    ...
    private static void createPostgresTestTable(DistributedTransactionAdmin admin) throws ExecutionException {
    ...
    private static void createPostgresNullTestTable(DistributedTransactionAdmin admin) throws ExecutionException {
